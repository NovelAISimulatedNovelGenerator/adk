...
var (
	...
	runCmd = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return runAgent(agentModule, saveSession, jsonOutput)
		},
	}
...
func init() {
    ...
    runCmd.Flags().BoolP("json", "j", false, "Output interactions in JSON format")
...
func runAgent(agentModule string, saveSession bool, jsonOutput bool) error {
